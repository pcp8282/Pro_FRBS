        ...
        RsubmitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (userIdIsValid(RuserIdFld.getText().toString())
                        ...
                        && isValid(RemailFld.getText().toString())) {
                    ...
                    if("register_ok".equals(result)){//가입 성공
                        ...
                        Toast.makeText(RegisterPage.this, "회원가입 실패했습니다", Toast.LENGTH_SHORT).show();
                    }
                }else
                    Toast.makeText(v.getContext(), "정보를 올바르게 입력해주세요", Toast.LENGTH_SHORT).show();
